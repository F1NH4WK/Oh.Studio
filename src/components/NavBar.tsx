...
export default function NavBar(){
    ...
    return(
        <div className = 'w-1/5 max-w-[35%] min-w-[1/5%] h-[3.1rem] flex flex-row text-white bg-navBar rounded-full p-[0.25rem] items-center justify-between fixed z-20 top-10 left-1/2 -translate-x-1/2 backdrop-blur-md'>
